...
(b) *Full look-through approach.* A Board-regulated institution that is able to calculate a risk-weighted asset amount for its proportional ownership share of each exposure held by the investment fund (as calculated under this subpart as if the proportional ownership share of the adjusted carrying value of each exposure were held directly by the Board-regulated institution) may set the risk-weighted asset amount of the Board-regulated institution's exposure to the fund equal to the product of:
