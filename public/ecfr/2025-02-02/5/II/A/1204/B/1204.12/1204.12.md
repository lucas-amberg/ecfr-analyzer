...
(b) *Definitions.* (1) The term *direct costs* means the costs to an agency for searching for and copying (and in the case of commercial requesters, reviewing) documents to respond to a FOIA request. Direct costs include, for example, the salary of each employee performing work at the rate of $5 per quarter hour. Overhead expenses, such as costs of space and of heating or lighting the facility in which the records are stored, are not included in direct costs.
...
(e) *Fee schedule.* (1) Fees for document searches for records will be charged at a rate of $5 per quarter hour spent by each Board employee performing the search.
