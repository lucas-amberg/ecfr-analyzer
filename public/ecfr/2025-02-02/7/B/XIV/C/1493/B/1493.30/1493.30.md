...
(a) *Qualification requirements.* To qualify for participation in the GSM-102 program, an applicant must submit the following information to CCC in the manner specified on the USDA Web site:
...
(d) *Ineligibility for program participation.* An applicant may be ineligible to participate in the GSM-102 program if such applicant cannot provide all of the information and certifications required by paragraph (a) of this section.
