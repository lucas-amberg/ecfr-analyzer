...
(b) To the extent that funds are available, each year NIFA will publish a _Federal Register_ notice announcing the program and soliciting grant applications. 
