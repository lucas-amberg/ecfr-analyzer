...
(2) *Proper filing of application*—(i) *Under section 245.* (A) An immigrant visa must be immediately available in order for an alien to properly file an adjustment application under section 245 of the Act See § 1245.1(g)(1) to determine whether an immigrant visa is immediately available.
