...
(a) As required by § 51.35, the appropriate NRC staff director will publish the finding of no significant impact in the _Federal Register._ The finding of no significant impact will be identified as a draft or final finding, and will contain the information specified in §§ 51.32 or 51.33, as appropriate. A draft finding of no significant impact will include a request for comments which specifies where comments should be submitted and when the comment period expires.
