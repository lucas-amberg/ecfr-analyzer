...
(a) *Covered events.* Subject to the exclusions set forth in paragraph (b) of this section, each Standby Support Contract shall include a provision setting forth the type of events that are covered events under the contract. The type of events shall include:
...
(b) *Exclusions.* Each Standby Support Contract shall include a provision setting forth the exclusions from covered costs under the contract, and for which any associated delay in the attainment of full power operations is not a covered delay. The exclusions are:
