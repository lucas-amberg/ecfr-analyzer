...
(a) *Establishment of allocated transfer risk reserve.* A banking institution shall establish an allocated transfer risk reserve (ATRR) for specified international assets when required by the OCC in accordance with this section. 
...
(*1*) Such obligors have failed to make full interest payments on external indebtedness;
...
(3) *Notification.* Based on the joint agency determinations under paragraph (b)(1) of this section, the OCC shall notify each banking institution holding assets subject to an ATRR:
...
(5) *Reduction of ATRR.* A banking institution may reduce an ATRR when notified by the OCC or, at any time, by writing down such amount of the international asset for which the ATRR was established.
