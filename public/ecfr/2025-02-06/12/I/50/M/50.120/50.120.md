...
(b) *Transition to a different required stable funding adjustment percentage.* (1) A national bank or Federal savings association whose required stable funding adjustment percentage changes is subject to the transition periods as set forth in § 50.105(c).
