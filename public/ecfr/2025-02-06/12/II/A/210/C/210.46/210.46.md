...
(a) *Payment to a receiving bank.* Payment of a Federal Reserve Bank's obligation to pay a receiving bank (other than a Federal Reserve Bank) occurs at the earlier of the time when the amount of the payment order is credited to the receiving bank's settlement account or when the payment order is sent to the receiving bank.
