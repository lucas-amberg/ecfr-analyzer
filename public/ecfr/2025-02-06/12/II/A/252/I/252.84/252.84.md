...
(c) *Definitions relevant to the general prohibitions*—(1) *Direct party.* Direct party means a covered entity or excluded bank that is a party to the direct QFC.
...
(e) *Definitions relevant to the general creditor protections*—(1) *Covered direct QFC.* Covered direct QFC means a direct QFC to which a covered entity or excluded bank is a party.
