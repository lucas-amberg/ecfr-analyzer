...
(c) *Requirements for initial margin model.* (1) A covered swap entity must obtain the prior written approval of FHFA before using any initial margin model to calculate the initial margin required in this part.
