...
(c) Whenever EDA determines that a Certified Firm no longer requires Adjustment Assistance or for other good cause, EDA will terminate the certification and promptly publish notice of such termination in the _Federal Register._ The termination will take effect on the date specified in the published notice. EDA shall immediately notify the petitioner and shall state the reasons for any termination.
