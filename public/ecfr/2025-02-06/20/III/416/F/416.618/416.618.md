...
(d) *How we consider advance designation when we select a representative payee.* (1) If we determine that payment will be made to a representative payee, we will review advance designees in the order listed by the individual and select the first advance designee who meets the criteria for selection. To meet the criteria for selection—
