...
b. *Employer name.* The name of the employer who reported the wage is necessary so that the worker may check the wage transcript and know whether it is correct. If the worker is given only the employer number, he may not be able to check the accuracy of the wage transcript.
