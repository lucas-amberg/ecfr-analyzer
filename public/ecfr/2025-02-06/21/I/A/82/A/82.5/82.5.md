...
(ii) Arsenic (as As_2_O_3_), not more than 0.00014 percent.
...
(ii) Arsenic (as As_2_O_3_), not more than 0.0002 percent.


(iii) Heavy metals (except Pb and As) (by precipitation as sulfides), not more than 0.003 percent.


(3) In the case of a straight color which contains a barium salt listed in subpart C or D—soluble barium (in dilute HCl) (as BaCl_2_), not more than 0.05 percent.
