...
(d) *Scientific literature.* A 15-day Alert report based on information in the scientific literature must be accompanied by a copy of the published article. The 15-day reporting requirements in paragraph (c)(1)(i) of this section (*i.e.*, serious, unexpected adverse drug experiences) apply only to reports found in scientific and medical journals either as case reports or as the result of a formal clinical trial.


(e) *Postmarketing studies.* An applicant is not required to submit a 15-day Alert report under paragraph (c) of this section for an adverse drug experience obtained from a postmarketing study (whether or not conducted under an investigational new drug application) unless the applicant concludes that there is a reasonable possibility that the drug caused the adverse experience. 
