...
(a) *Identification.* An indwelling blood carbon dioxide partial pressure P_CO2_ analyzer is a device that consists of a catheter-tip P_CO2_ transducer (e.g., P_CO2_ electrode) and that is used to measure, in vivo, the partial pressure of carbon dioxide in blood to aid in determining the patient's circulatory, ventilatory, and metabolic status.
