...
(e) If the application is accepted for filing, the Administrator shall issue and publish in the _Federal Register_ an order on the application, which shall include a reference to the legal authority under which the order is based. This order shall specify the date on which it shall take effect.
