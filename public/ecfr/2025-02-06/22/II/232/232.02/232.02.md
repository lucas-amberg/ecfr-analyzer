...
*Application for Compensation* means an executed application in the form of Appendix A to this part which a Noteholder, or the Fiscal Agent on behalf of a Noteholder, files with USAID pursuant to § 232.08.


*Borrower* means Banque Centrale de Tunisie, acting on behalf of the Republic of Tunisia.
...
*Date of Application* means the date on which an Application for Compensation is actually received by USAID pursuant to § 232.15.
...
*Eligible Note(s)* means [a] Note[s] meeting the eligibility criteria set out in § 232.04.
...
*Guarantee* means the guarantee of USAID pursuant to this part 232 and the State, Foreign Operations, and Related Programs Appropriations Act of 2012 (Pub. L. 112-74).
