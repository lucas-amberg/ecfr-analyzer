...
*Application for Compensation* means an executed application in the form of Appendix A to this part which a Noteholder, or the Fiscal Agent on behalf of a Noteholder, files with USAID pursuant to § 235.8.
...
*Date of application* means the date on which an Application for Compensation is actually received by USAID pursuant to § 235.15.
...
*Eligible Note(s)* means [a] Note[s] meeting the eligibility criteria set out in § 235.4.
