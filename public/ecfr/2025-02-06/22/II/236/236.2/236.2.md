...
*Application for Compensation* means an executed application in the form of Appendix A to this part which a Noteholder, or the Fiscal Agent on behalf of a Noteholder, files with USAID pursuant to § 236.8.
...
*Date of application* means the date on which an Application for Compensation is actually received by USAID pursuant to § 236.15.
...
*Eligible Note(s)* means [a] Note[s] meeting the eligibility criteria set out in § 236.4.
...
*Guarantee* means the guarantee of USAID issued pursuant to this part and Section 7041(g)(1)(A) of the Department of State, Foreign Operations, and Related Programs Appropriations Act, 2014 (Div. K, Pub. L. 113-76).
