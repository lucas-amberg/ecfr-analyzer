...
*Application for Compensation* means an executed application in the form of Appendix A to this part which a Noteholder, or the Fiscal Agent on behalf of a Noteholder, files with USAID pursuant to § 238.8.
...
*Date of Application* means the date on which an Application for Compensation is actually received by USAID pursuant to § 238.15.
...
*Eligible Note(s)* means [a] Note[s] meeting the eligibility criteria set out in § 238.4 issued in one or more series.
...
*Guarantee* means the guarantee of USAID issued pursuant to this part and Section 7034(r) of the Department of State, Foreign Operations, and Related Programs Appropriations Act, 2015 (Div. J, Pub. L. 113-235).
...
*Note[s]* means any debt securities issued by the Borrower in one or more series.
