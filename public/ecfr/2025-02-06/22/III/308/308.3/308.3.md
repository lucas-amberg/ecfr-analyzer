...
(b) *System of Records* means a group of any records under the control of the agency from which information is retrieved by use of the name of an individual or by some identifying number, symbol, or other identifying particular assigned to the individual.
