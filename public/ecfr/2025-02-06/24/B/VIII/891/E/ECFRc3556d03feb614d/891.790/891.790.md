...
(a) *General.* Vacancy payments under the PAC will not be made unless the conditions for receipt of these project assistance payments set forth in this section are fulfilled. 
...
(c) *Vacancies after rent-up.* If an eligible family vacates an assisted unit (or residential space in a group home) the Borrower is entitled to vacancy payments in the amount of 80 percent of the contract rent (or pro rata share of the contract rent in a group home) for the first 60 days of vacancy if the Borrower: 
...
(d) *Vacancies for longer than 60 days.* If an assisted unit (or residential space in a group home) continues to be vacant after the 60-day period specified in paragraph (b) or (c) of this section, HUD may approve additional vacancy payments for 60-day periods up to a total of 12 months in an amount equal to the principal and interest payments required to amortize that portion of the debt service attributable to the vacant unit (or, in the case of group homes, the residential space). Such payments may be approved if: 
