...
(4) *Taxpayer.* The term *taxpayer* means any person to whom the Act applies.


(5) *Other terms.* All other terms which are not specifically defined shall have the same meaning as when used in the Code except where otherwise distinctly expressed or manifestly intended.
