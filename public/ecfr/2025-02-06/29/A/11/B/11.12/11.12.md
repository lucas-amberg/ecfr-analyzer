...
(a) An environmental assessment may be prepared in any format considered effective by the agency involved. When such a document is prepared in connection with a proposed action, it must be made readily available to the public either by placement into the public record (with public notice provided in accordance with 40 CFR part 1506) or by publication in the _Federal Register._ The preamble to the _Federal Register_ notice of proposed rulemaking may be considered the environmental assessment provided that the document contains the elements required by 40 CFR 1508.9(b). 
