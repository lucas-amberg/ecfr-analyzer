...
(g) Subsection (e)(4)(G) and (H) of 5 U.S.C. 552a requires an agency to publish a _Federal Register_ notice of its procedures whereby an individual can be notified upon request whether the system of records contains information about the individual, how to gain access to any record about the individual contained in the system, and how to contest its content.
