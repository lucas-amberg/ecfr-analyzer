...
*Sedimentation pond* means any natural or artificial structure or depression used to remove sediment from water and store sediment or other debris.


*Slope* means average inclination of a surface, measured from the horizontal. Normally expressed as a unit of vertical distance to a given number of units of horizontal distance (e.g., 1*v* to 5*h* = 20 percent = 11.3 degrees). 
...
[N] [42 FR 62677, Dec. 13, 1977, as amended at 44 FR 30628, May 25, 1979] 
