...
(c) *Exceptions.* (1) A broker-dealer is not required to file a SAR to report:
...
(g) *Compliance.* Broker-dealers shall be examined by FinCEN or its delegatees for compliance with this section. Failure to satisfy the requirements of this section may be a violation of the Bank Secrecy Act and of this chapter.


(h) *Applicability date.* This section applies to transactions occurring after December 30, 2002.
