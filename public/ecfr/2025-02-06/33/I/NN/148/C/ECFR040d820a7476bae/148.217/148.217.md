...
(a) Adjacent Coastal States are named in the notice of application published in the _Federal Register._ However, a State not named as an Adjacent Coastal State in the notice may request to be designated as one if the environmental risks to it are equal to or greater than the risks posed to a State directly connected by pipeline to the proposed deepwater port.


(b) The request must:


(1) Be submitted in writing to the Commandant (CG-5P) within 14 days after the date of publication of the notice of application in the _Federal Register_;
