...
(a) A same day service standard is applied to USPS Connect_TM_ Local Mail pieces properly accepted at participating Destination Delivery Units before the day-zero Critical Entry Time (CET); a one day service standard is applied to USPS Connect_TM_ Local Mail pieces accepted via carrier pick-up or properly accepted at participating Destination Delivery Units after the day-zero CET.
...
(g) The service standard for Outbound Single-Piece First-Class Mail International
TM; pieces properly accepted before the day-zero CET is equivalent to the service standard for domestic First-Class Mail pieces originating from the same 3-digit ZIP Code area and destined to the 3-digit ZIP Code area in which the designated International Service Center is located.
...
[N] [86 FR 43952, Aug. 11, 2021, as amended at 87 FR 73469, Nov. 30, 2022]
