...
(a) Allotments are made on a formula or other basis which Congress specifies for each fiscal year (FY). The allotment for each State and the availability period shall be announced each fiscal year in the _Federal Register._ This section applies only to funds allotted under section 205 of the Act.
