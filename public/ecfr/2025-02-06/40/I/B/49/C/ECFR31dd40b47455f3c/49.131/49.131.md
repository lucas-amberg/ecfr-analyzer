...
(d) *What are the requirements for open burning?* (1) A person must not openly burn, or allow the open burning of, the following materials:
...
(e) *Are there additional requirements that must be met?* (1) A person subject to this section must conduct open burning as follows:
