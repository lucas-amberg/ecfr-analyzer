...
(a) If, in the Administrator's judgment, an alternative means of emission limitation will achieve a reduction in emissions of VOC from any emission point subject to § 60.712(c) or (d) (standards for mix equipment) at least equivalent to that required by § 60.712 (c) or (d), respectively, the Administrator will publish in the _Federal Register_ a notice permitting the use of the alternative means. The notice may condition permission on requirements related to the operation and maintenance of the alternative means.
