...
(a) For each affected EGU subject to this subpart, you must not discharge from the affected EGU any gases that contain CO_2_ in excess of the applicable CO_2_ emission standard specified in table 1 to this subpart, consistent with paragraphs (b), (c), and (d) of this section, as applicable.
...
(d) Owners or operators of a stationary combustion turbine that maintain records of electric sales to demonstrate that the stationary combustion turbine is subject to a heat input-based standard in table 1 to this subpart that are only permitted to burn one or more uniform fuels, as described in paragraph (d)(1) of this section, are only subject to the monitoring requirements in paragraph (d)(1). Owners or operators of all other stationary combustion turbines that maintain records of electric sales to demonstrate that the stationary combustion turbines are subject to a heat input-based standard in table 1 are only subject to the requirements in paragraph (d)(2) of this section.
