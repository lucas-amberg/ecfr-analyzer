...
(B) The applicable performance specifications (*e.g.,* relative accuracy tests) in appendix B of part 60 of this chapter.


(C) The applicable procedures (*e.g.,* quarterly accuracy determinations and daily calibration drift tests) in appendix F of part 60 of this chapter.
