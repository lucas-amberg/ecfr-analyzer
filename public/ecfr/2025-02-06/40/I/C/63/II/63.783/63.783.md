...
(c) *Approval of alternative means of limiting emissions.* (1) The owner or operator of an affected source may apply to the Administrator for permission to use an alternative means (such as an add-on control system) of limiting emissions from coating operations. The application must include: 
