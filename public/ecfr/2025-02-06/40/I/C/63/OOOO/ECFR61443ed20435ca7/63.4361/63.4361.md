...
(c) *Liquid-to-uncaptured-gas protocol using a temporary total enclosure or building enclosure.* The liquid-to-uncaptured-gas protocol compares the mass of liquid TVH in regulated materials applied in the web coating/printing or dyeing/finishing operation to the mass of TVH emissions not captured by the emission capture system. Use a temporary total enclosure or a building enclosure and the procedures in paragraphs (c)(1) through (6) of this section to measure emission capture system efficiency using the liquid-to-uncaptured-gas protocol.
