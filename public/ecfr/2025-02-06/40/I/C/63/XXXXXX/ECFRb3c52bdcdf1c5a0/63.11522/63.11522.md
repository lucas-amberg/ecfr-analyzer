...
*Control device* means equipment installed on a process vent or exhaust system that reduces the quantity of a pollutant that is emitted to the air.
...
*Filtration control device* means a control device that utilizes a filter to reduce the emissions of MFHAP and other PM.
...
*Vented dry abrasive blasting* means dry abrasive blasting where the blast material is moved by air flow from within the chamber to outside the chamber into the atmosphere or into a control device.
