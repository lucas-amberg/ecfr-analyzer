...
(5) To determine compliance with the PM emissions limit in paragraph (c) of this section for an EAF or AOD vessel in a lb/ton of steel format, compute the process-weighted mass emissions (E_p_) for each test run using Equation 1 of this section: 
