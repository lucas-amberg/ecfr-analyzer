...
(2) *Interim review of monitoring plan.* The Administrator will determine, on an interim basis, the sufficiency of the monitoring plan, accompanying the opt-in permit application. A monitoring plan is sufficient, for purposes of interim review, if the plan appears to contain information demonstrating that all SO_2_ emissions, NO_X_ emissions, CO_2_ emissions, and opacity of the combustion or process source are monitored and reported in accordance with part 75 of this chapter. This interim review of sufficiency shall not be construed as the approval or disapproval of the combustion or process source's monitoring system.
