...
(2) *Physical and chemical information.* The substitute should be characterized by its key properties including but not limited to: Molecular weight; physical state; melting point; boiling point; density; taste and/or odor threshold; solubility; partition coefficients (Log K_ow_, Log K_oc_); atmospheric lifetime and vapor pressure. 
