...
(c) *Serial numbers for allocated CAIR SO*_2_*allowances.* When recording the allocation of CAIR SO_2_ allowances issued by a permitting authority under § 97.288, the Administrator will assign each such CAIR SO_2_ allowance a unique identification number that will include digits identifying the year of the control period for which the CAIR SO_2_ allowance is allocated.
