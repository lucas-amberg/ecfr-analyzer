# § 97.260   Submission of CAIR SO

(a) A CAIR authorized account representative seeking recordation of a CAIR SO_2_ allowance transfer shall submit the transfer to the Administrator. To be considered correctly submitted, the CAIR SO_2_ allowance transfer shall include the following elements, in a format specified by the Administrator:


(1) The account numbers of both the transferor and transferee accounts;


(2) The serial number of each CAIR SO_2_ allowance that is in the transferor account and is to be transferred; and
