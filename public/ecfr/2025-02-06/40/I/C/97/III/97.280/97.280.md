...
A CAIR SO_2_ opt-in unit must be a unit that:
...
(b) Is not a CAIR SO_2_ unit under § 97.204 and is not covered by a retired unit exemption under § 97.205 that is in effect;
