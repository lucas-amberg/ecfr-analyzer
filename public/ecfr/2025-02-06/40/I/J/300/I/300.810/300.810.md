...
(a) *Contents.* The administrative record file for selection of a response action typically, but not in all cases, will contain the following types of documents:
