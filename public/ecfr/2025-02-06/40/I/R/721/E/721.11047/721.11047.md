...
(i) *Industrial, commercial, and consumer activities.* Requirements as specified in § 721.80(f) and (k). It is a significant new use to manufacture the substance such that the lowest number average molecular weight is less than 1,800 daltons and the carboxylic acid content exceeds 20 percent.
