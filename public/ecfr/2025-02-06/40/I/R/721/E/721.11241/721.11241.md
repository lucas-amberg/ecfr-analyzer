...
(iii) *Industrial, commercial, and consumer activities.* Requirements as specified in § 721.80(f). It is a significant new use to use the substance other than as a phlegmatizer (stabilizer for compounds susceptible to detonation) for peroxides for use with polyester and vinyl ester resins as well as with curable unsaturated polyester and methacrylic resins.
