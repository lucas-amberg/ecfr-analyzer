...
(g) For Clinical Research for Individuals from Disadvantaged Background only: Individual must be from a disadvantaged background. (See § 68.2, Definitions, *Individual from disadvantaged background.*)
