...
(a) *Standard: Notice of rights.* (1) An REH must inform each patient, or when appropriate, the patient's representative (as allowed under state law), of the patient's rights, in advance of furnishing or discontinuing patient care whenever possible.
...
(d) *Standard: Confidentiality of patient records.* (1) The patient has the right to the confidentiality of their medical records.
...
(g) *Standard: Death reporting requirements.* REHs must report deaths associated with the use of seclusion or restraint.
