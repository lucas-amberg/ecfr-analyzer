...
(b) *ALJ order.* The ALJ will issue an order under § 45.41(b) with respect to any discovery motion requesting the use of written interrogatories. The order will:
