...
(c) In lieu of testing each sample for the components required under paragraph (b) of this section, the operator may periodically test for these components and adjust the assumed C_6_+ composition to remove bias in the heating value (see § 3175.126(a)(3)). The C_6_+ composition must be applied to the mole percent of C_6_+ analyses until the next analysis is done under paragraph (b) of this section. The minimum analysis frequency for the components listed in paragraph (b) of this section is as follows:
