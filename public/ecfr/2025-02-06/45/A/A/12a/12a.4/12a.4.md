...
(a) Properties published by HUD as suitable and available, pursuant to 24 CFR 581.8, for application for use to assist the homeless shall not be available for any other purpose for a period of 30 days beginning on the date the list of properties is published on the HUD website. Any eligible organization interested in any underutilized, unutilized, excess, or surplus property for use to assist the homeless must send HHS a written expression of interest in that property within 30 days after the property has been published on the HUD website.
