...
(a) *Submission of plans.* An institution to which § 86.16 applies and which is composed of more than one administratively separate unit may submit either a single transition plan applicable to all such units, or a separate transition plan applicable to each such unit. 


(b) *Content of plans.* In order to be approved by the United States Commissioner of Education, a transition plan shall: 
