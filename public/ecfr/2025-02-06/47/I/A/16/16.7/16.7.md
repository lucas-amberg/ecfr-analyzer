...
(b) *Response.* After review of a request submitted hereunder, the Enforcement Bureau will:


(1) Issue an advisory opinion that will state the Bureau's determination as to whether or not the policy or practice detailed in the request complies with the Commission's rules implementing section 60506 of the Infrastructure Act;
