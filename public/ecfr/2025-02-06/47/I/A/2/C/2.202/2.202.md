...
(f) Determination of values of *D* and *B*_n_ for systems specified in paragraph (c)(2) of this section:
...
(2) The necessary bandwidth (*B*_n_) normally is considered to be numerically equal to:


(i) 2*M* + 2*DK,* for systems having no continuity pilot subcarrier or having a continuity pilot subcarrier whose frequency is not the highest modulating the main carrier;


(ii) 2*P* + 2*DK,* for systems having a continuity pilot subcarrier whose frequency exceeds that of any other signal modulating the main carrier, unless the conditions set forth in paragraph (f)(3) of this section are met.


(3) As an exception to paragraph (f)(2)(ii) of this section, the necessary bandwidth (*B*_n_) for such systems is numerically equal to 2*P* or 2*M* + 2*DK*, whichever is greater, provided the following conditions are met:
...
[N] [28 FR 12465, Nov. 22, 1963, as amended at 37 FR 8883, May 2, 1972; 37 FR 9996, May 18, 1972; 48 FR 16492, Apr. 18, 1983; 49 FR 48698, Dec. 14, 1984; 68 FR 68543, Dec. 9, 2003]
