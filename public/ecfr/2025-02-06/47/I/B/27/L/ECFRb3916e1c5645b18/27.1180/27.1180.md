...
(a) An AWS licensee that relocates a BRS system with which it interferes is entitled to *pro rata* reimbursement based on the cost-sharing formula specified in § 27.1164, except that the depreciation factor shall be [180−T_m_]/180, and the variable *C* shall be applied as set forth in paragraph (b) of this section.
