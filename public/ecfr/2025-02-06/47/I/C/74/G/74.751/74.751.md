...
(c) Notwithstanding the requirements in paragraph (b) of this section, a station may file in LMS a correction of geographic coordinates where the change is 3 seconds or fewer in latitude and/or 3 seconds or fewer in longitude, provided there is no physical change in location and no other licensed parameters are changed. An exhibit should be attached to the application(s) specifying that it is a coordinate correction. 
