...
(1) 2N_1_ + N_2_ + 72 ≤0 for VHF-FM sound broadcasting signals in the range 107.7-108 MHz; and 


(2) 2N_1_ + N_2_ + 3 (24 −20log delta *f*/0.4) ≤0 for VHF-FM sound broadcasting signals below 107.7 MHz, where the frequencies of the two VHF-FM sound broadcasting signals produce, within the receiver, a two signal, third-order intermodulation product on the desired VDB frequency. 


(3) In the formulas in paragraphs (d)(1) and (d)(2) of this section, N_1_ and N_2_ are the levels (dBm) of the two VHF FM sound broadcasting signals at the VHF data broadcast (VDB) receiver input. Neither level shall exceed the desensitization criteria set forth in paragraph (c) of this section. Delta *f* = 108.1 − *f*_1_, where *f*_1_ is the frequency of N_1_, the VHF FM sound broadcasting signal closer to 108.1 MHz.



---

[N] [69 FR 32881, June 14, 2004]
