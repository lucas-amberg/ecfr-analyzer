...
(b) Each CTS where the antenna does not exceed 6.1 meters (20 feet) above ground or an existing structure (other than an antenna structure) and is outside the vicinity of certain receiving locations (*see* § 1.924 of this chapter) is authorized under the 218-219 MHz System license. All other CTSs must be individually licensed.
