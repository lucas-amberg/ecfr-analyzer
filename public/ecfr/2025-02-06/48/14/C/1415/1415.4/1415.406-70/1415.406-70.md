...
(c) *Procedures.* When the CO prepares the memorandum prescribed in FAR 15.406-3, the following additional information shall be included to the extent it applies to the contract action. Information already contained in the contract file or in a previous PNM shall be referenced by location:
...
(d) *Approval.* The PNM shall be signed and dated by the contract specialist or contract negotiator who conducted the negotiation and approved by the CO.


(e) *Distribution.* Whenever field pricing support has been obtained, copies of related PNMs shall be forwarded to the Assistant Inspector General for Auditing, OIG, not later than 15 days after the execution of the resulting contract, modification or close-out action.
