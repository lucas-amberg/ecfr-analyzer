...
(b) *Contract clause.* Insert the clause at 1852.225-70, Export Licenses, in all solicitations and contracts, except in contracts with foreign entities. Insert the clause with its Alternate I when the NASA project office indicates that technical data (including software) is to be exchanged by the contractor with a NASA foreign partner pursuant to an international agreement. 
