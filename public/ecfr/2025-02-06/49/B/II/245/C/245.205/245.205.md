...
(a) After a railroad's certification program has received its initial approval from FRA, pursuant to § 245.103(f)(1), the railroad must maintain a list of each person who is currently certified as a dispatcher by the railroad. The list must include the date of the railroad's certification decision and the date the person's certification expires.
