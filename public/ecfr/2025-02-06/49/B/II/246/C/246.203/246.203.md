...
(7) Relevant data from the railroad's records concerning the person's success or failure on knowledge test(s) under § 246.121;


(8) A sample copy of the written knowledge test or tests administered; and


(9) The relevant data from the railroad's records concerning the person's success or failure on unannounced tests the railroad performed to monitor the person's performance in accordance with § 246.123.
