...
(b) For an LOA modification or renewal requests by the applicant that include changes to the activity or the mitigation, monitoring, or reporting (excluding changes made pursuant to the adaptive management provision in in paragraph (c)(1) of this section) that do not change the findings made for the regulations or result in no more than a minor change in the total estimated number of takes (or distribution by species or years), OPR may publish a notice of proposed LOA in the _Federal Register,_ including the associated analysis of the change, and solicit public comment before issuing the LOA.
