...
(a) *Motion and notice.* Except upon agreement of the parties, a party wishing to take a deposition must file a motion under § 1.641(c). Any notice of deposition filed with the motion must state:
...
(b) *ALJ order.* The ALJ will issue an order under § 1.641(b) with respect to any discovery motion requesting the taking of a deposition. The order will:
...
(h) *Use of deposition.* A deposition may be used at the hearing as provided in § 1.653.
