...
(4) *Minor blemished cherry* means any cherry blemished with skin discoloration (other than scald) having an aggregate area of a circle 
...
(b) (*A*) *classification.* Canned red tart pitted cherries that are practically free from defects may be given a score of 27 to 30 points. “Practically free from defects” means that the number of defects that may be present does not exceed the number specified for the type of defects in Table IV.
