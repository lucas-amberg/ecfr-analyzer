...
(2) *Merchant Mariner Document.* A U.S. citizen who holds a valid Merchant Mariner Document (MMD) issued by the U.S. Coast Guard may present an unexpired MMD used in conjunction with official maritime business when entering the United States.
...
(*3*) For each child, the primary address, primary phone number, date of birth, place of birth, and name of a parent or legal guardian.
